...
<div class="row">
    ...
    <div class="col-md-4 offset-4 " style="word-wrap: break-word;">
        ...
        <br>
        <strong>Administrátorské meno je admin@admin.admin a heslo 123456.</strong>
        <br>
        <strong>Užívateľsky účet meno: frantisek.ff.ff@gmail.com a heslo frantisek</strong>
        <br>
